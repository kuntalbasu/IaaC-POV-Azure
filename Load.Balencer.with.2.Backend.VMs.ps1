...
# Declaire you infra here by chnaging or adding variebles
    ...
    $AvailibilitySet1 = "BreakMe1AbilitySet1"
...
#############################################################################################
    ...
    -Name BreakMe1NetworkSecurityGroup -SecurityRules $NSGRuleRDP
     ...
     # Creating Availibity Set
    New-AzAvailabilitySet -Location $Location -Name $AvailibilitySet1 -ResourceGroupName $ResourceGroup -Sku aligned -PlatformFaultDomainCount 2 -PlatformUpdateDomainCount 2
...
# Only change the VMName veriable in every paste.
    ...
    New-AzVM -ResourceGroupName $ResourceGroup -Location $Location -VM $VirtualMachine -AvailabilitySetName $AvailibilitySet1 -Verbose
